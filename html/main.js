...
(function(exports) {
  ...
  var runStringify = function (dictShow) {
      return function (v) {
          return v.value0;
      };
  };
  ...
  var multStringify = new Mult(function (v) {
      return function (v1) {
          return Stringify.create("(" + (v.value0 + (" * " + (v1.value0 + ")"))));
      };
  });
  var multEval = new Mult(function (v) {
      return function (v1) {
          return Eval.create(v.value0 * v1.value0);
      };
  });
  var exprStringify = new Expr(function (v) {
      return function (v1) {
          return Stringify.create("(" + (v.value0 + (" + " + (v1.value0 + ")"))));
      };
  }, function ($45) {
      return Stringify.create(Data_Show.show(Data_Show.showBoolean)($45));
  }, function (dictEq) {
      return function (v) {
          return function (v1) {
              return Stringify.create("(" + (v.value0 + (" == " + (v1.value0 + ")"))));
      ...
      return Stringify.create(Data_Show.show(Data_Show.showNumber)($46));
  });
  var exprEval = new Expr(function (v) {
      return function (v1) {
          return Eval.create(v.value0 + v1.value0);
      };
  }, Eval.create, function (dictEq) {
      return function (v) {
          return function (v1) {
              return Eval.create(Data_Eq.eq(dictEq)(v.value0)(v1.value0));
          };
      };
  }, Eval.create);
  exports["Eval"] = Eval;
...
(function(exports) {
  ...
  var Text_Smolder_Markup = PS["Text.Smolder.Markup"];        
  var expr2 = function (dictMult) {
      return function (dictExpr) {
          return function (x) {
              return function (y) {
                  return function (z) {
                      return Palto.pmul(dictMult)(Palto.pint(dictExpr)(x))(Palto.padd(dictExpr)(Palto.pint(dictExpr)(y))(Palto.pint(dictExpr)(z)));
                  };
              };
          };
      };
  ...
  var h = function (x) {
      return function (y) {
          return function (z) {
              return Data_Semigroup.append(Text_Smolder_Markup.semigroupMarkupM)(Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupMF)(Text_Smolder_HTML.div)(Text_Smolder_HTML_Attributes.style("background-color: #f3f"))(Text_Smolder_Markup.text(Palto.runStringify(Data_Show.showNumber)(expr2(Palto.multStringify)(Palto.exprStringify)(x)(y)(z)))))(Data_Semigroup.append(Text_Smolder_Markup.semigroupMarkupM)(Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupMF)(Text_Smolder_HTML.div)(Text_Smolder_HTML_Attributes.style("background-color: #abc"))(Text_Smolder_Markup.text(" = ")))(Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupMF)(Text_Smolder_HTML.div)(Text_Smolder_HTML_Attributes.style("background-color: #ccc"))(Text_Smolder_Markup.text(Data_Show.show(Data_Show.showNumber)(Palto.runEval(expr2(Palto.multEval)(Palto.exprEval)(x)(y)(z)))))));
          };
      };
  };
  var ui0 = Control_Apply.apply(Flare.applyUI)(Control_Apply.apply(Flare.applyUI)(Data_Functor.map(Flare.functorUI)(h)(Flare.number("x")(5.0)))(Flare.number("y")(3.0)))(Flare.number("z")(2.0));
